...
function getClockPickerUtilityClass(slot) {
  return (0, _core.generateUtilityClass)('MuiClockPicker', slot);
}

const clockPickerClasses = (0, _core.generateUtilityClasses)('MuiClockPicker', ['arrowSwitcher']);
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _core.unstable_composeClasses)(slots, getClockPickerUtilityClass, classes);
};
