...
exports.default = exports.defaultReduceAnimations = exports.calendarPickerClasses = void 0;
...
function getCalendarPickerUtilityClass(slot) {
  return (0, _core.generateUtilityClass)('MuiCalendarPicker', slot);
}

const calendarPickerClasses = (0, _core.generateUtilityClasses)('MuiCalendarPicker', ['root', 'viewTransitionContainer']);
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _core.unstable_composeClasses)(slots, getCalendarPickerUtilityClass, classes);
};
