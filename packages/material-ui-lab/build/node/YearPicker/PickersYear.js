...
function getPickersYearUtilityClass(slot) {
  return (0, _core.generateUtilityClass)('PrivatePickersYear', slot);
}

const pickersYearClasses = (0, _core.generateUtilityClasses)('PrivatePickersYear', ['root', 'modeMobile', 'modeDesktop', 'yearButton', 'disabled', 'selected']);
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _core.unstable_composeClasses)(slots, getPickersYearUtilityClass, classes);
};
