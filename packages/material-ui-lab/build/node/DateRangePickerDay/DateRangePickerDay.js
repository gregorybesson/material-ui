...
function getDateRangePickerDayUtilityClass(slot) {
  return (0, _core.generateUtilityClass)('MuiDateRangePickerDay', slot);
}

const dateRangePickerDayClasses = (0, _core.generateUtilityClasses)('MuiDateRangePickerDay', ['root', 'rangeIntervalDayHighlight', 'rangeIntervalDayHighlightStart', 'rangeIntervalDayHighlightEnd', 'rangeIntervalPreview', 'rangeIntervalDayPreview', 'rangeIntervalDayPreviewStart', 'rangeIntervalDayPreviewEnd', 'day', 'dayOutsideRangeInterval', 'dayInsideRangeInterval', 'notSelectedDate']);
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _core.unstable_composeClasses)(slots, getDateRangePickerDayUtilityClass, classes);
};
